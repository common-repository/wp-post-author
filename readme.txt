...
* Activate.
* WP Post Author blocks, widgets, shortcodes will be available for WordPress.
...
1. Post Author Bio Box with Social Icons
2. Multiple Authors Box - Co-Authors and Guest Authors
3. Post Rating Section
4. User Registration Form Builder 
5. ReCaptcha V2/V3 Settings
...
= 3.8.0 =
* New: Login page selection option added
* New: Register page selection option added
* New: Post Ratetd users list added
...
= 3.7.4 =
* Update: Query Optiomzation
* Update: Scripts Optiomzation

= 3.7.3 =
* Update: Speed Optiomzation
* Update: Query Optiomzation
* Update: Scripts Optiomzation

= 3.7.2 =
* Update: Security Improvement
* Update: Rating API Improvement
* Update: General Improvement

= 3.7.1 =
* Update: Security Improvement
* Update: Multi-author Improvement
* Update: General Improvement
...
= 3.6.2 =
* Update: Review Star with title Improvement
* Update: Rating Improvement
* Update: General Improvement

= 3.6.1 =
* Update: Star ratings on post title Improvement
* Update: Blocks keywords Improvement
* Update: Video tutorials provided on the dashboard
* Update: General Improvement

= 3.6.0 =
* Update: Co-Author Posts Improvement
* Update: PHP 8.2 Compatibility Improvement
* Update: FontAwesome 6 Loaded
* Update: Twitter Icon Change

= 3.5.5 =
* Update: Author Posts Improvement
* Update: Rating General Improvement

= 3.5.4 =
* New: Display rating posts title option added
* Option Area: Navigate to WP Post Author Dashboard > Rating > Show Reviewed Rating with Post Title
* Update: WP Post Author Module Improvement
* Update: WP Post Author Dashboard Improvement
* Update: WP Post Author Shortcode Improvement
* Update: General Improvement
...
= 3.5.2 =
* Update: Multi Author archive title improvement
* Update: General Improvement
...
= 3.5.0 =
* New: Post Rating System introduced
* Update: Registration form display based on WordPress settings
* Update: General Improvement
