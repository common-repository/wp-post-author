...
class WP_Post_Author_Frontend
{
    ...
    public function awpa_post_author_enqueue_style()
    {
        ...
        if(awpa_post_author_add_custom_style()){
        ...
        wp_localize_script(
            ...
            array(
                ...
                'messages'=>[
                    'loggedin'=>__('You are already logged in.', 'wp-post-author'),
                    'register_disable'=>__('Registration is disabled by admin.', 'wp-post-author'),
                    'admin_note'=>__('To enable anyone can register option please follow the link', 'wp-post-author'),
